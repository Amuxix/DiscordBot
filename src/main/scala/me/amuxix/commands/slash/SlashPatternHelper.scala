...
object SlashPatternHelper:
  ...
  /*extension (event: SlashCommandInteractionEvent)
    inline def get[T](option: String): T = SlashPatternHelper.getOption[T](event, option)*/